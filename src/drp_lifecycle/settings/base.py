"""
Django settings for drp_lifecycle project.
...
from drp_lifecycle.utils.environ import Env

ROOT_DIR = Path(__file__) - 3  # Three folders back

APPS_DIR = ROOT_DIR.path('drp_lifecycle')
...
ROOT_URLCONF = 'drp_lifecycle.urls'
...
WSGI_APPLICATION = 'drp_lifecycle.wsgi.application'
